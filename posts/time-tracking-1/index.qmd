...
data_long <- read.csv("data.csv") %>%
  mutate(
    ...
    category5 = case_when(
      activity %in% c("Sleep", "Sport", "Communication", "Japanese", "Food") ~ activity,
      activity %in% c("Study", "Work", "TM", "Planning", "Reading") ~ "Study/Work",
      activity %in% c("Transportation", "Misc", "Waste") ~ "Rest"
    ),
    hour = hour(datetime),
...
# activity_colors_grey_special <- c(
#    "Sleep" = "navy",  # Indigo
#    "Japanese" = "firebrick3",  # Gold
#    "Study" = "yellow",  # Slate Blue
#    "Communication" = "darkgreen",  # Light Blue
#    "Sport" = "#5e5e5e",  # LimeGreen
#    "Food" = "#d0d0d0",
#    "Misc" = "#bababa") 
# 
# plot_color <- activity_colors_grey_special
