...
You are at a nice party, music playing, drinks pouring, people laughing. You are with a group of friends enjoying a conversation. Then one person starts telling a funny story, everyone is laughing. But then after the story is over the person doesn't stop talking, forces another story and another talking endlessly and, effectively, hijacking the conversation. You can't help but feel frustrated: how come they don't let others talk, they take too much time! 

We all had a situation in our life when someone is taking too much of our time. We 

When someone wastes your precious time talking nonsense, you can't help but wish they just shut up. Nonsense part we can accept - people think differently, have strong opinions that this all good, but the sense of lost time is hard to forget. You feel like you could have spent this time differently, done smth useful. 


In Toastmasters you are always told to mind the time, there is a special role dedicated specifically to that. You, me, everyone has a limited time and we can't afford to waste it. When someone is wasting our time talking, you can't help but wish they just shut up.
...
[^3]: There are many reports that don't include TT winner or times of some speakers. Some speaker volunteer two or more times, which complicates analysis.

In total there 180 unique meetings in the dataset. Our sample is representative, as the number of men and women[^4] is almost equal.

[^4]: The gender of the speaker was assigned post hoc, based on the reports/photos of the meeting, common sense and a little bit of prejudice :)
...
With regards to TT participants names there are a total of 312 unique names[^5].

[^5]: In reports the same people were reported under slightly different names. For example: Alexey/Aleksey/Alex/Aleks/Oleksiy/Oleksey.... and their counterpart Cyrillic versions. To deal with this issue, I simply renamed these to Alex. Similar approach was with other names.
...
Strangely enough, if the proportion of men in TT session increases - then TT session will be be sorter. Also, having more men speak during TT session is associated with lower TT times.
...
plot(x = data_logit$speaker_order, 
     y = data_logit$TT,
     main = "Probit and Logit Models Model of the P(Winning TT | Speaker Order)",
     xlab = "Speaker Order",
...
"Consider naming your baby Alex or Andrew - this will set them up for good life" - Vadym Yudenko[^7]


:::
:::

[^7]: FYI, this is a joke and not meant to be taken seriously.
...
[famous speeches](https://youtube.com/playlist?list=PLosaC3gb0kGCnvkRvp8aOF4OIuGaqDHG8)

one safe rule of thumb is to speak for between [90-100% of your allowed time](http://sixminutes.dlugan.com/presentation-timing/).
